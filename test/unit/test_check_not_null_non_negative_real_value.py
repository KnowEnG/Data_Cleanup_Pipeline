...
class Testcheck_check_input_data_value(unittest.TestCase):
    def setUp(self):
    ...
    def test_check_nan_input_value_in_spreadsheet(self):
        ret_df = data_cln.check_input_data_value(self.input_df_nan, check_na=True, dropna_colwise=False,
    ...
    def test_check_text_input_value_in_spreadsheet(self):
        ret_df = data_cln.check_input_data_value(self.input_df_text, check_na=False, dropna_colwise=False,
                                                 check_real_number=True,
                                                 check_positive_number=False)
        ret_flag = ret_df is not None
        self.assertEqual(False, ret_flag)
    ...
    def test_check_negative_input_value(self):
        ret_df = data_cln.check_input_data_value(self.input_df_negative, check_na=False, dropna_colwise=False,
                                                 check_real_number=False,
                                                 check_positive_number=True)
        ret_flag = ret_df is not None
        self.assertEqual(False, ret_flag)
